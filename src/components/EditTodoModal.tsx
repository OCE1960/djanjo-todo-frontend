...
import {  update, getAllTodos, selectTodoRecord } from "../state-management/features/todoSlice"
...
const EditTodoModal: React.FC<ModalProps> = ({ modalIsOpen, setModalOpen } : ModalProps) => {
  const dispatch = useAppDispatch();
  const todoRecord = useAppSelector(selectTodoRecord);
  const initialValues = { title:  todoRecord.title ? todoRecord.title : "",
                         is_completed: todoRecord.completed ? "true" : "", 
                         description: todoRecord.description ? todoRecord.description : ""};
      ...
      centered>
       ...
       validationSchema={Yup.object({
          ...
          onSubmit={ async (values, actions) => {
            ...
            formData.append("id", todoRecord.id);
